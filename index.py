...
#**********ACCESSING FILES CONTAINING LIST OF ITEMS**********
...
#**********MAKING FOOD ORDER PAGE IN OUTPUT**********
...
def def_payment():
    while True:
        ...
        if (input_1 == 'P'):
            ...
            file_report.close()
            print("*" * 32 + "THANK YOU VISIT AGAIN" + "*" * 31 + "\n")
            def_default()
            break
        elif (input_1 == 'M'):
            print("\n" * 10)
...
def_main() #CALLING MAIN FUNCTION